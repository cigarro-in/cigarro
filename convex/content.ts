...
// ---------- TEMPORARY backfill (delete after Wave 2 PROD verification) ----------
// Restored temporarily 2026-09-14: DEV was backfilled, but PROD
// (prestigious-bass-64, auto-deploys code on push) has empty tables.
// Backfill PROD, verify, then DELETE this block again.
