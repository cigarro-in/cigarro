...
import { useMyReviews } from '../../hooks/data/useProductReviews';
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          {reviews.length === 0 ? (
            ...
            <div className="space-y-4">
              {reviews.map((review) => (
                <Card key={review._id} className="border-2 border-border/40 hover:border-accent/30 transition-all">
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                      ...
                      <div className="flex-1">
                        <div className="flex items-start justify-between mb-2">
                          <div>
                            <h3 className="font-medium text-lg mb-1">
                              <Link to={`/product/${review.product?.slug}`} className="hover:text-accent transition-colors">
                            ...
                            <div className="flex items-center gap-4 text-sm text-muted-foreground">
                              ...
                              {!review.isApproved && (
                                <span className="text-xs text-yellow-700">Awaiting moderation</span>
                              )}
                            </div>
                          </div>
                        ...
                        <div className="mt-4 flex justify-end">
                            <Link to={`/product/${review.product?.slug}`} className="text-sm text-accent hover:text-accent-dark font-medium flex items-center gap-1">
