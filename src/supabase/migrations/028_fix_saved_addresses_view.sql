-- Fix saved_addresses view to handle INSERTs properly
-- This adds the missing INSTEAD OF trigger for the view
...
-- Also add UPDATE and DELETE triggers for complete compatibility
