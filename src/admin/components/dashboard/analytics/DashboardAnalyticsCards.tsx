...
export function DashboardAnalyticsCards({ analytics, loading = false }: DashboardAnalyticsCardsProps) {
  if (loading) {
    return (
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{analytics.totalVariants}</div>
          <p className="text-xs text-muted-foreground">
            Total variants
          </p>
        </CardContent>
